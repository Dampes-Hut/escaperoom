...
NaviColor sNaviColorList[] = {
    /* ACTORCAT_SWITCH     */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_BG         */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_PLAYER     */   { { 200, 255, 200, 255 }, {   0, 255, 100, 0 } },
    /* ACTORCAT_EXPLOSIVE  */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_NPC        */   { { 150, 150, 255, 255 }, { 150, 150, 255, 0 } },
    /* ACTORCAT_ENEMY      */   { { 255, 255,   0, 255 }, { 200, 155,   0, 0 } },
    /* ACTORCAT_PROP       */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_ITEMACTION */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_MISC       */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_BOSS       */   { { 255, 255,   0, 255 }, { 200, 155,   0, 0 } },
    /* ACTORCAT_DOOR       */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_CHEST      */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
    /* ACTORCAT_MAX        */   { {   0, 255,   0, 255 }, {   0, 255,   0, 0 } },
};
...
#else // kludge for actors not using real file & line numbers
