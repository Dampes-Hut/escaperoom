...
*/
SceneCmd test_darklink_puzzle_scene_header00[] = {
    SCENE_CMD_SOUND_SETTINGS(0x00, 0x00, NA_BGM_FIELD_LOGIC),
    SCENE_CMD_ROOM_LIST(1, test_darklink_puzzle_scene_roomList),
    SCENE_CMD_MISC_SETTINGS(0x00, 0x00),
    SCENE_CMD_COL_HEADER(&test_darklink_puzzle_collisionHeader),
    SCENE_CMD_SPECIAL_FILES(0x00, OBJECT_GAMEPLAY_DANGEON_KEEP),
    SCENE_CMD_SKYBOX_SETTINGS(0x01, 0x00, LIGHT_MODE_TIME),
    SCENE_CMD_ENTRANCE_LIST(test_darklink_puzzle_scene_header00_entranceList),
    SCENE_CMD_SPAWN_LIST(1, test_darklink_puzzle_scene_header00_playerEntryList),
    SCENE_CMD_ENV_LIGHT_SETTINGS(4, test_darklink_puzzle_scene_header00_lightSettings),
    SCENE_CMD_END(),
};

RomFile test_darklink_puzzle_scene_roomList[] = {
    { (u32)_test_darklink_puzzle_room_0SegmentRomStart, (u32)_test_darklink_puzzle_room_0SegmentRomEnd },
};

ActorEntry test_darklink_puzzle_scene_header00_playerEntryList[] = {
    {
...
Spawn test_darklink_puzzle_scene_header00_entranceList[] = {
    // { Spawn Actor List Index, Room Index }
    { 0, 0 },
};

EnvLightSettings test_darklink_puzzle_scene_header00_lightSettings[4] = {
    // Dawn Lighting
    {
