...
typedef struct {
    ...
    /* 0x00008 */ Gfx polyOpaBuffer[0x3000];
    /* 0x18008 */ Gfx polyXluBuffer[0x1000];
    /* 0x20008 */ Gfx overlayBuffer[0x800];
    /* 0x24008 */ Gfx workBuffer[0x80];
    /* 0x24408 */ u16 tailMagic; // GFXPOOL_TAIL_MAGIC
} GfxPool; // size = 0x24410
